...
$query_PARTIDA = "SELECT ID, DESCRIPCION_COMPLETA FROM partidas";
...
?>
<tr>
	<td width="398" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Partida:
	<td align="left" bgcolor="#F3F3F3" >
		<select id="combobox" name="ID_PARTIDA_COMISION" width="300" style="width: 300px; font-size:10px">
			...
			do {  
			?>
			<option value="AND ID_PARTIDA=<?php echo $row_PARTIDA['ID']?>"<?php if (!(strcmp($row_PARTIDA['ID'], 0))) {echo "selected=\"selected\"";} ?>>[ID:<?php echo $row_PARTIDA['ID']?>] <?php echo $row_PARTIDA['DESCRIPCION_COMPLETA']?></option>
			<?php
