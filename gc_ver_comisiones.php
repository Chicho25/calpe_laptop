    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
              Ver comisiones  <small>ver o editar comisiones.</small>
            </h1>
        </div>
...
<!-- Dynamic Table Full -->
    <div class="block">
        <div class="block-header">
            <h3 class="block-title">Tabla de comisiones <small>todas las comisiones</small></h3>
        </div>
        <div class="block-content">
            ...
            <table class="table table-bordered table-striped js-dataTable-full">
                ...
                <tbody>
                    <?php $documento_partida = ver_comisiones($conexion2); ?>
