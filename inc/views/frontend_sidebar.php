...
<nav id="sidebar">
    ...
    <div id="sidebar-scroll" style="width:25px !important;">
        <!-- Sidebar Content -->
        <!-- Adding .sidebar-mini-hide to an element will hide it when the sidebar is in mini mode -->
        <div class="sidebar-content" style="width:25px !important;">
            <!-- Side Header -->
            <div class="side-header side-content">
                ...
                <a class="h5 text-white" href="frontend_home.php">
                    <i class="fa fa-circle-o-notch text-primary"></i> <span class="h4 font-w600 sidebar-mini-hide">Grupo Calpe</span>
                </a>
            </div>
            <!-- END Side Header -->
            ...
            <div class="side-content">
                <ul class="nav-main" style="width:25px !important;">
                    <?php $one->build_nav(); ?>
                </ul>
            </div>
            <!-- END Side Content -->
