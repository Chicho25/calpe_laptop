        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-content block-content-narrow">
                    ...
                    <form class="form-horizontal" action="reportes/gc_reporte_ingreso.php" method="post" target="_blank">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="js-select2 form-control" name="id_formato" style="width: 100%;" data-placeholder="Seleccionar Formato">
                                    <option value="">Selecionar</option>
