...
<ul id="MenuBar1" class="MenuBarHorizontal">
            ...
            <li><a href="<?php echo $clave_bd['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd['DESCRIPCION_MENU']; ?></a>
            <ul>
            ...
            <li><a href="<?php echo $clave_bd1['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd1['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd1['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd1['DESCRIPCION_MENU']; ?></a>
            <ul>
            ...
            <li><a href="<?php echo $clave_bd2['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd2['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd2['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd2['DESCRIPCION_MENU']; ?></a>
			<ul>
            ...
            <li><a href="<?php echo $clave_bd3['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd3['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd3['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd3['DESCRIPCION_MENU']; ?></a>
            <ul>
            ...
            <li><a href="<?php echo $clave_bd4['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd4['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd4['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd4['DESCRIPCION_MENU']; ?></a>
            <ul>
            ...
            <li><a href="<?php echo $clave_bd5['LINK_MENU']; ?>?titulo_menu=<?php echo $clave_bd5['DESCRIPCION_MENU']; ?>"<?php if ($clave_bd5['LINK_MENU']=='pdf.php'){ ?> target="_blank" <?php }?> class="MenuBarItemSubmenu"><?php echo $clave_bd5['DESCRIPCION_MENU']; ?></a>
                </li><?php } } ?></ul>
                </li><?php } } ?></ul>
                </li><?php } } ?></ul>
                </li><?php } } ?></ul>
