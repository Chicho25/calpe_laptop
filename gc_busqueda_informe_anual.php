          ...
          <div class="col-lg-12">
              <div class="block">
                  ...
                  <div class="block-content block-content-narrow">
                      <form class="js-validation-bootstrap form-horizontal" action="gc_informe_anual.php" method="post">
                          <div class="form-group">
                              <div class="col-md-12">
                                <?php $sql = $conexion2 -> query("select * from	maestro_proyectos"); ?>
                                <select name="proyecto" class="form-control" style="width: 100%;">
                                    <option value="">MOSTRAR TODAS LAS PARTIDAS</option>
                          ...
                          <div class="form-group">
                              <div class="col-md-12">
                                  ...
                                  <select class="js-select2 form-control" id="val-select2" name="partida" style="width: 100%;">

                                      <option value="">Seleccione una Partida en especifico</option>
