        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-content block-content-narrow">
                    ...
                    <form class="form-horizontal" action="reportes/gc_estado_cuenta_clientes.php" method="post" target="_blank">
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="val-username">Cliente<span class="text-danger">*</span></label>
                            <div class="col-md-9">

                                <select class="js-select2 form-control" name="id_cliente" style="width: 100%;" data-placeholder="Seleccionar empresa" required="required">
                                    <option></option>
                                    <?php   $sql_clientes = estado_cuentas_clientes($conexion2); ?>
                                    <?php   while($lista_clientes = mysqli_fetch_array($sql_clientes)){ ?>
                                    <option value="<?php echo $lista_clientes['id_cliente']; ?>">
                                                   <?php echo $lista_clientes['cl_nombre'].' '.$lista_clientes['cl_apellido']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <div class="input-group input-daterange gcreacion">
                                  <input type="text" class="js-datepicker form-control fechas1" autocomplete="off" name="fcreacion_inicio" placeholder="Desde">
