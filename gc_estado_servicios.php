        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                <div class="block-header">
                    ...
                    <h3 class="block-title">Servicios</h3><small> Los campos con <span class="text-danger">*</span> son obligatorios</small>
                </div>
                <div class="block-content block-content-narrow">
                    <form class="form-horizontal" action="gc_estado_servicios_result.php" method="post">
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="val-username">Status<span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <select class="js-select2 form-control" name="status_service" style="width: 100%;" data-placeholder="Seleccionar empresa" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <div class="input-group input-daterange gcreacion">
                                  <input type="text" class="js-datepicker form-control fechas1" autocomplete="off" name="fecha1" placeholder="Desde">
                                  <div style="min-width: 0px" class="input-group-addon"></div>
                                  <input type="text" class="js-datepicker form-control fechas1" autocomplete="off" name="fecha2" placeholder="Hasta">
                              </div>
                            </div>
                        </div>
                        <div class="form-group">
