        ...
        <div class="block-content">
            ...
            <table class="table table-bordered table-striped js-dataTable-full">
                ...
                <tbody>
                    ...
                    <?php $todos_inmuebles = todos_inmuebles($conexion2);} ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $lista_todos_inmuebles['proy_nombre_proyecto']; ?></td>
                        ...
                        <td class="text-center"><?php echo $lista_todos_inmuebles['im_nombre_inmueble']; ?></td>
