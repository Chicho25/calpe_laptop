          ...
          <div class="col-lg-12">
              <div class="block">
                  ...
                  <div class="block-content block-content-narrow">
                      <form class="js-validation-bootstrap form-horizontal" action="reportes/reporte_historial_alquileres.php" method="post" target="_blank">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                          <form class="" action="reportes/reporte_historial_alquileres.php" method="post" target="_blank">
