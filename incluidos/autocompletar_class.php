<?php
class auto
	{function objeto($ancho,$tabla,$where,$label,$nombre_campo_form,$nombre_campo_mostrar,$nombre_campo_value,$parametro,$boton, $accion){
?>
...
<tr align="left" valign="middle" class="Campos">
	...
	<td width="751">
	  <select name="<?php echo $nombre_campo_form; ?>" id="<?php echo $nombre_campo_form; ?>"  align="absmiddle">
		...
		do {  
	?>
	    <option value="<?php echo $parametro; ?><?php echo $row_proveeedor[$nombre_campo_value]?>"<?php echo $parametro; ?><?php if (!(strcmp($row_proveeedor[$nombre_campo_value], 0))) {echo "selected=\"selected\"";} ?>><?php echo htmlentities($row_proveeedor[$nombre_campo_mostrar])?></option>
	    <?php
...
?>
    ...
    <?php if($boton==1) {
	  ?><img src="../img/search.png" alt="search_" width="28" height="28"  title="Buscar" align="absmiddle" onclick="javascript:<?php echo $accion; ?>"/><?php }elseif($boton==4){ ?><a href="../clientes/list.php?RESERV=<?php echo $_GET['ID_INMUEBLE_MASTER_RESERVA']; ?>"><?php if (validador(18,$_SESSION['i'],"inc")==1) {?><img src="../img/folder_new.png" width="24" height="24" title="Crear Clientes"/><?php } ?></a><?php } ?></td>
	</tr>
<?php }} ?>
   <!-- </table>-->
