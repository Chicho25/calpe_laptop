          ...
          <div class="col-lg-12">
              <div class="block">
                  ...
                  <div class="block-content block-content-narrow">
                      <form class="js-validation-bootstrap form-horizontal" action="reportes/gc_reporte_3.php" method="post" target="_blank">
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="val-username">Proyecto</label>
                          <div class="col-md-7">
                                <select class="js-select2 form-control" id="marca" name="id_proyecto" style="width: 100%;">

                                    <option value="">Resumen Todos los Proyectos</option>
                                    <?php $sql_proyecto = reporte_3_seleccionar_proyecto($conexion2); ?>
                        ...
                        <?php /* ?><div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select class="js-select2 form-control" name="id" style="width: 100%;" data-placeholder="Seleccionar tipo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                              <select class="js-select2 form-control" name="vendedor" id="val-select2" style="width: 100%;">
                      ...
                      <?php if(isset($_POST['id_proyecto'])){ ?>
                        <table class="table table-bordered table-striped js-dataTable-full">
                            ...
                            <tbody>
                                <?php $reporte1 = reporte_3($conexion2, $_POST['id_proyecto']); ?>
                                <?php while($r1 = $reporte1->fetch_array()){ ?>
                                <tr>

                                    <td class="font-w600"><?php echo $r1['ven_nombre'].' '.$r1['ven_apellido']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['grupo_inmueble']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['cl_nombre'].' '.$r1['cl_apellido']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['cv_fecha_hora']; ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                          <form class="" action="reportes/gc_reporte_3.php" method="post" target="_blank">
                                           <input type="hidden" name="id_proyecto" value="<?php echo $r1['id_venta']; ?>">
