        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                <div class="block-header">
                    ...
                    <h3 class="block-title">Reporte de Termino</h3><small> Los campos con <span class="text-danger">*</span> son obligatorios</small>
                </div>
                <div class="block-content block-content-narrow">
                    <!-- jQuery Validation (.js-validation-bootstrap class is initialized in js/pages/base_forms_validation.js) -->
                    <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                    <form class="form-horizontal" action="reportes/gc_reporte_termino.php" method="post" target="_blank">
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="val-username">Termino<span class="text-danger">*</span></label>
                            <div class="col-md-9">
