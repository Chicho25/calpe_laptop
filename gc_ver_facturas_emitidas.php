          ...
          <div class="col-lg-12">
              <div class="block">
                  ...
                  <div class="block-content block-content-narrow">
                      <form class="js-validation-bootstrap form-horizontal" action="gc_ver_documentos_partidas.php" method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-7">
                                        <?php $sql = $conexion2 -> query("select * from maestro_proyectos"); ?>
                                          <select id="partida" class="form-control" style="width: 100%;" name="partida">
