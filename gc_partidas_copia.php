            ...
            <div class="col-lg-12">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-narrow">
                      ...
                      <?php include "modulo_partidas_copia/php/functions.php"; ?>
                        	...
                        	<div class="row">
                              ...
                              <form action="" method="post">
                                <select class="js-select2 form-control" id="val-select2" name="id_proyecto" style="width: 100%;" data-placeholder="Seleccionar Proyecto " onChange="this.form.submit()">
                                    ...
                                    <option value="<?php echo $lista_proyecto['id']; ?>" <?php if(isset($_POST['id_proyecto'])){
                                                                                                  if($_POST['id_proyecto'] == $lista_proyecto['id']){ echo "selected";}
                              ...
                              <ul id="lista2">
                                ...
                                <?php if($_SESSION['session_gc']['roll'] == 3){  /* ################  Cuando el usuario sea de gerencia  ################## */ ?>
                                 ...
                                 <?php if(count($categories)>0):?>
                                	...
                                	<?php foreach($categories as $cat):?>
                                		<li><?php echo $cat["p_nombre"]." ".add_btn($cat["id"], $cat["p_monto"] - $cat["p_distribuido"])."
                                                                                             <b>Asignado ".number_format($cat["p_monto"], 2, '.', ',')." ||
                               ...
                               <?php }else{ /* ################  Cuando el usuario no sea gerencia  ################## */ ?>

                                 <?php if(count($categories)>0):?>
                                	<ul id="lista2">
                                	<?php foreach($categories as $cat):?>
                                		<li><?php echo $cat["p_nombre"]." <b>Monto estimado ".number_format(suma_total($cat["id"]), 2, ',','.')."</b>"; ?> </li>
                                		<?php
                                		list_tree_cat_id_admin($cat["id"]);
                                		?>
                                	<?php endforeach;?>
                                	</ul>
                                <?php else:?>
