...
<div class="content">
    ...
    <div class="block">
        ...
        <div class="block-content">
          <form class="" action="reportes/gc_estado_servicios_pdf.php" method="post" target="_blank">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if ($_POST['status_service'] == 1) {
                       $where .= " AND s.stat = 1 ";

                       if($_POST['fecha1'] != ''){ $where .= " AND s.date_time >= '".date('Y-m-d',strtotime($_POST['fecha1']))." 00:00:00'"; }
                       if($_POST['fecha2'] != ''){ $where .= " AND s.date_time <= '".date('Y-m-d',strtotime($_POST['fecha2']))." 23:59:59'"; }

                    }elseif ($_POST['status_service'] == 3) {
                       $where .= " AND s.stat = 3 ";

                       if($_POST['fecha1'] != ''){ $where .= " AND s.fecha_pago >= '".date('Y-m-d',strtotime($_POST['fecha1']))." 00:00:00'"; }
                       if($_POST['fecha2'] != ''){ $where .= " AND s.fecha_pago <= '".date('Y-m-d',strtotime($_POST['fecha2']))." 23:59:59'"; }
                    } ?>
                    ...
                    <?php while($lista_todos_contratos_ventas = $todos_contratos_ventas -> fetch_array()){
                      ...
                      if($lista_todos_contratos_ventas['stat']==1){
                        ...
                        }elseif($lista_todos_contratos_ventas['stat']==3){
