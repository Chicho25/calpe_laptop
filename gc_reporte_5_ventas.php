                      ...
                      <form class="js-validation-bootstrap form-horizontal" action="" method="post">
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                                  <select class="js-select2 form-control" id="marca" name="id_proyecto" style="width: 100%;" data-placeholder="Seleccionar Proyecto" required="required">
                                      <option></option>
                                      <?php $sql_proyecto = reporte_5_select_proyecto($conexion2); ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-7">
                                  <select class="js-select2 form-control" name="" style="width: 100%;" data-placeholder="Seleccionar tipo">
                                    <option value="">Seleccionar</option>
                                    <?php $sql=$conexion2->query("select id_vendedor, ven_nombre, ven_apellido from maestro_vendedores"); ?>
                                    <?php while($i=$sql->fetch_array()){ ?>
                                    <option value="<?php echo $i['id_vendedor']; ?>"><?php echo $i['ven_nombre'].' '.$i['ven_apellido']; ?></option>
                                    <?php } ?>
                                  </select>
                              </div>
                          </div>
                        ...
                        <table class="table table-bordered table-striped js-dataTable-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-xs">Fecha de Venta</th>
                                    <th class="text-center" style="width: 10%;">Ver Reporte</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $reporte1 = reporte_5($conexion2, $_POST['id_proyecto']); ?>
                                <?php while($r1 = $reporte1->fetch_array()){ ?>
                                <tr>

                                    <td class="font-w600"><?php echo $r1['id_inmueble']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['gi_nombre_grupo_inmueble']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['mi_nombre']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['ven_nombre'].' '.$r1['ven_apellido']; ?></td>
                                    <td class="hidden-xs"><?php echo $r1['fecha_venta']; ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                          <form class="" action="reportes/gc_reporte_5.php" method="post" target="_blank">
                                           <input type="hidden" name="id_inmueble" value="<?php echo $r1['id_inmueble']; ?>">
